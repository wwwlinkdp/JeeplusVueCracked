...
public class UserController {
    ...
    public void exportFile(UserDTO userDTO, Page <UserDTO> page, ExcelOptions options, HttpServletResponse response) throws Exception {
        ...
        EasyExcelUtils.newInstance ( userService, UserWrapper.INSTANCE).exportExcel ( result,   options.getSheetName ( ), UserDTO.class, fileName,options.getExportFields (), response );
    }
